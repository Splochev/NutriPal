...
import { useNutritionCalculatorStyles, MACRO_NUTRIENTS } from '../../../Services/NutritionCalculatorService';
...
export const FoodInfoPopoverButton: React.FC<FoodInfoPopoverButtonProps> = ({ foodDto }) => {
                ...
                <div className={classes.popover}>
                    ...
                    <div className={classes.popoverNutritionContainer}>
                        {MACRO_NUTRIENTS.map((nutrient) => (
                            <div key={nutrient.name + nutrient.icon} className={classes.label}>
                                ...
                                />
                                <div>
                                    <Typography variant="subtitle2" className={classes.nutritionValue}>
                                        {/* @ts-ignore */}
