...
import { calculateNutrients, chooseFood, useNutritionCalculatorStyles } from '../Services/NutritionCalculatorService';
        ...
        <div>
            <div className={classes.toolbar}>
                ...
                <CoreIconButton
                    ...
                    disabled={!$chosenFoods.value.some((item) => typeof item === 'object')}
                    onClick={() => $chosenFoods.set([`divider-${uuidv4()}`, ...$chosenFoods.value])}
                />
            </div>
